...
export default function AddRecipeScreen() {
  ...
  const inputBackgroundColor = isDarkMode ? '#262626' : '#ffffff';
  const inputBorderColor = isDarkMode ? '#374151' : '#e5e7eb';
    ...
    <SafeAreaView style={[styles.container, { backgroundColor }]}>
      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.inputGroup}>
          ...
          <View style={[styles.imageUrlContainer, { backgroundColor: inputBackgroundColor, borderColor: inputBorderColor }]}>
            <TextInput
              ...
              placeholderTextColor={placeholderTextColor}
            />
            <View style={[styles.imageIconContainer, { borderLeftColor: inputBorderColor }]}>
              <ImageIcon size={20} color={secondaryTextColor} />
            </View>
          </View>
        </View>
        ...
        <View style={styles.row}>
          ...
          <View style={[styles.inputGroup, styles.halfWidth]}>
            ...
            <View style={[styles.difficultyContainer, { backgroundColor: inputBackgroundColor }]}>
              <TouchableOpacity
                style={[
          ...
          {ingredients.map((ingredient, index) => (
            ...
            >
              <View style={styles.ingredientNameContainer}>
                <TextInput
                  style={[styles.ingredientName, { backgroundColor: inputBackgroundColor, borderColor: inputBorderColor, color: textColor }]}
              ...
              <View style={styles.ingredientQuantityContainer}>
                <TextInput
                  style={[styles.ingredientQuantity, { backgroundColor: inputBackgroundColor, borderColor: inputBorderColor, color: textColor }]}
              ...
              <View style={styles.ingredientUnitContainer}>
                <TextInput
                  style={[styles.ingredientUnit, { backgroundColor: inputBackgroundColor, borderColor: inputBorderColor, color: textColor }]}
          ...
          {steps.map((step, index) => (
            ...
            >
              ...
              <View style={styles.stepInputContainer}>
                <TextInput
                  style={[styles.stepInput, { backgroundColor: inputBackgroundColor, borderColor: inputBorderColor, color: textColor }]}
                  value={step}
